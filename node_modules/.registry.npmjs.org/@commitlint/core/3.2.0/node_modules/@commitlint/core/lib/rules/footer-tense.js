...
exports.default = function (parsed, when, value) {
	...
	return [negated ? !matches : matches, (0, _message2.default)([`tense of footer must`, negated ? `not` : null, `be ${value}. Verbs in other tenses: ${offenders}`])];
};

module.exports = exports['default'];
//# sourceMappingURL=footer-tense.js.map