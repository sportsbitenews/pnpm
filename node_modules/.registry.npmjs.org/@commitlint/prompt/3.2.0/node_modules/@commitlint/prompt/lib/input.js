...
function input(prompter) {
	return new Promise(function ($return, $error) {
		...
		return Promise.resolve((0, _core.load)()).then(function ($await_1) {
			try {
				_ref = $await_1, rules = _ref.rules;
				return Promise.resolve(Promise.all(['type', 'scope', 'subject', 'body', 'footer'].map((0, _throat2.default)(1, function (input) {
					return new Promise(function ($return, $error) {
